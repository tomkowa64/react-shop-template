          ...
          >
            ...
            <div
              ...
              className={
                ...
                (this.state.IsMenuItemShowed ? "w3-show" : null)
              }
            >
